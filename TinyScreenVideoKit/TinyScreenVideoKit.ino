...
void loop() {
//  drawBitmap(displaySecondary);
//  drawBitmap(displayTertiary);
...
void drawBitmap(TinyScreen screen){
  //set a background that matches
  screen.drawRect(0,0,96,64,TSRectangleFilled,TS_8b_Blue);
